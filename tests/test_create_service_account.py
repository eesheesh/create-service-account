...
class TestCreateServiceAccount(unittest.TestCase):
    ...
    def test_gwmme_config(self):
        ...
        self.assertEqual(create_service_account.TOOL_NAME_FRIENDLY, "Google Workspace Migration for Microsoft Exchange")
        self.assertIn("admin.googleapis.com", create_service_account.APIS)
        self.assertIn("https://www.googleapis.com/auth/contacts", create_service_account.SCOPES)
    ...
    def test_gwm_config(self):
        ...
        self.assertEqual(create_service_account.TOOL_NAME_FRIENDLY, "Google Workspace Migrate")
    ...
    def test_custom_arguments_override(self):
        ...
        self.assertEqual(create_service_account.TOOL_NAME_FRIENDLY, "My Custom Tool")
        self.assertEqual(create_service_account.TOOL_HELP_CENTER_URL, "https://custom.url")
        self.assertEqual(create_service_account.APIS, ["api1.googleapis.com", "api2.com"])
        self.assertEqual(create_service_account.SCOPES, ["https://www.googleapis.com/auth/scope1", "https://scope2"])
    ...
    def test_api_suffix_logic(self):
        ...
        create_service_account.setup_config(args)
        expected_apis = ["admin.googleapis.com", "calendar-json.googleapis.com", "custom.api.com"]
